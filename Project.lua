...
local PhantomForcesWindow = Library:NewWindow("💎 Neon.C Hub 💎")
...
KillingCheats:CreateToggle("Auto Detect Spam", function(value)
...
KillingCheats:CreateToggle("Hold Block To Spam", function(value)
...
KillingCheats:CreateToggle("Player Esp", function(value)
...
local MainKillingCheats = PhantomForcesWindow:NewSection("💎 Traning Mode")

MainKillingCheats:CreateButton("Auto Parry [TRANING MODE]", function()
...
local HereKillingCheats = PhantomForcesWindow:NewSection("💎 Socials")

HereKillingCheats:CreateButton("💎 YouTube", function()
print("PremiumOnlyUser")
end)

HereKillingCheats:CreateButton("@justneoncat", function()
print("PremiumOnlyUser")
end)

HereKillingCheats:CreateButton("💎 Discord", function()
print("PremiumOnlyUser")
end)

HereKillingCheats:CreateButton("neoncat0502", function()
print("PremiumOnlyUser")
end)
